...
from ..views import RunProjectView
from ..models import RunProjectModel
from ..commons.utils import link_working_dir


class RunProjectController(PageController):
    def __init__(self) -> None:
        super().__init__()
        self.project_config = None
        self.view = RunProjectView()
        self.model = RunProjectModel()
